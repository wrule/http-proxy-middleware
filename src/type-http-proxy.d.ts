...
> extends events.EventEmitter {
  ...
  on(
    event: 'econnreset',
    listener: Server.EconnresetCallback<Error, TIncomingMessage, TServerResponse>,
  ): this;
...
declare namespace Server {
  ...
  type StartCallback<
    TIncomingMessage = http.IncomingMessage,
    TServerResponse = http.ServerResponse,
  > = (req: TIncomingMessage, res: TServerResponse, target: ProxyTargetUrl) => void;
  ...
  type ProxyResCallback<
    TIncomingMessage = http.IncomingMessage,
    TServerResponse = http.ServerResponse,
  > = (proxyRes: TIncomingMessage, req: TIncomingMessage, res: TServerResponse) => void;
  ...
  type EconnresetCallback<
    ...
    TIncomingMessage = http.IncomingMessage,
    TServerResponse = http.ServerResponse,
  > = (err: TError, req: TIncomingMessage, res: TServerResponse, target: ProxyTargetUrl) => void;
  type EndCallback<
    TIncomingMessage = http.IncomingMessage,
    TServerResponse = http.ServerResponse,
  > = (req: TIncomingMessage, res: TServerResponse, proxyRes: TIncomingMessage) => void;
